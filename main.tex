...
\caption{   Graph visualization showing interconnected account and transaction entities with multi-hop transactional relationships.}
...
\caption{Hybrid multi-modal graph-learning architecture .}
